...
class IncomingLetterController extends Controller
{
    ...
    {
        return view('pages.sekretaris.incoming.index', [
    ...
    {
        return view('pages.sekretaris.incoming.agenda', [
    ...
    public function print(Request $request): View
    {
        ...
        return view('pages.sekretaris.incoming.print', [
    ...
    {
        return view('pages.sekretaris.incoming.create', [
    ...
    public function store(StoreLetterRequest $request): RedirectResponse
    {
        try {
            ...
            return redirect()
                ->route('sekretaris.incoming.index')
    ...
    {
        return view('pages.sekretaris.incoming.show', [
    ...
    {
        return view('pages.sekretaris.incoming.edit', [
            'data' => $incoming,
            'classifications' => Classification::all(),
        ]);
    }
