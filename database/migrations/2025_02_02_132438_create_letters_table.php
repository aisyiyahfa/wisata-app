...
return new class extends Migration
{
    ...
    $table->foreign('classification_code')->references('code')->on('classifications')->onDelete('cascade');
    $table->foreignId('user_id')->constrained('users')->cascadeOnUpdate()->onDelete('cascade');
            $table->timestamps();
        });
    }
