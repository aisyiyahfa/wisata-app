            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        @if (Auth::user()->role_id == 1)
                            <li
                                class="nav-item {{ request()->is('roles*') || request()->is('user*') || request()->is('jabatan*') ? 'menu-open' : '' }}">
                        ...
                        @if (in_array(Auth::user()->role_id, [1,3]))
                            <li
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('kategori-rekening.index') }}"
                                            class="nav-link  {{ request()->is('kategori-rekening*') ? 'active' : '' }}">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('transaksi.index') }}"
                                            ...
                                            <i class="fa-solid fa-money-bill-transfer  nav-icon"
                                                aria-hidden="true"></i>
                        ...
                        @if (in_array(Auth::user()->role_id, [1,4]))
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('kategori-surat.index') }}"
                                            class="nav-link  {{ request()->is('kategori-surat*') ? 'active' : '' }}">
                                            <i class="fa fa-tags nav-icon" aria-hidden="true"></i>
                                            <!-- Ikon kategori -->
                                            <p>Kategori Surat</p>
                                        </a>
                            ...
                            <li
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('jam-reservasi.index') }}"
                                            class="nav-link  {{ request()->is('jam-reservasi*') ? 'active' : '' }}">
